...
var FormikTextArea = function (_Component) {
  _inherits(FormikTextArea, _Component);

  function FormikTextArea(props) {
    _classCallCheck(this, FormikTextArea);

    var _this = _possibleConstructorReturn(this, (FormikTextArea.__proto__ || Object.getPrototypeOf(FormikTextArea)).call(this, props));

    _this.id = props.id || "field_textarea_" + fieldCounter++;
    return _this;
  }

  _createClass(FormikTextArea, [{
    key: "render",
